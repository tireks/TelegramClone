...
import com.tirex_projs.telegram_clone.ui.fragments.ContactsFragment
...
import com.tirex_projs.telegram_clone.utilits.USER
import com.tirex_projs.telegram_clone.utilits.downloadAndSetImage
...
class AppDrawer (){
    ...
    private fun clickToItem(position : Int){
        when (position) {
            7 -> APP_ACTIVITY.replaceFragment(SettingsFragment(), R.id.dataContainer)
