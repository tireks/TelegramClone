...
import com.tirex_projs.telegram_clone.databinding.ActivitySampleResultScreenBinding

//import com.example.croppersample.R
//import com.example.croppersample.databinding.ActivityCropResultBinding

class SampleResultScreen : Activity() {
    private lateinit var binding: ActivitySampleResultScreenBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        binding = ActivitySampleResultScreenBinding.inflate(layoutInflater)
